我是添加的内同/******/ (function() { // webpackBootstrap
/******/ 	"use strict";
...
var _Homepage = _interopRequireDefault(__webpack_require__(15));
...
var App = function App(_a) {
  ...
  var _b = __read((0, _react.useState)("哈哈哈"), 2),
    data = _b[0],
    setData = _b[1];
...
root.render((0, _jsxRuntime.jsx)(App, {
  children: (0, _jsxRuntime.jsx)(_Homepage["default"], {})
}));
